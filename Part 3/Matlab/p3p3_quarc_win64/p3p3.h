...
typedef struct {
  ...
  real_T Pxr[2];                       /* '<S5>/P x r' */
  real_T Kimatrix[10];                 /* '<S4>/Ki matrix' */
...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } e_dot_PWORK;                       /* '<Root>/e_dot' */

  struct {
    void *LoggedData;
  } e_dot_c_PWORK;                     /* '<Root>/e_dot_c  ' */
  ...
  struct {
    void *LoggedData;
  } ElevationScopedeg_PWORK;           /* '<S2>/Elevation: Scope [deg]' */

  struct {
    void *LoggedData;
  } PitchScopedeg_PWORK;               /* '<S2>/Pitch: Scope [deg]' */

  struct {
    void *LoggedData;
  } PtichrateScopedegs_PWORK;          /* '<S2>/Ptich rate: Scope [deg//s]' */

  struct {
    void *LoggedData;
  } TravelrateScopedegs1_PWORK;        /* '<S2>/Travel rate: Scope [deg//s]1' */

  struct {
    void *LoggedData;
  } TravelScopedeg_PWORK;              /* '<S2>/Travel: Scope [deg]' */
...
typedef struct {
  ...
  real_T int1_CSTATE;                  /* '<S6>/int 1' */
  real_T int2_CSTATE;                  /* '<S6>/int 2' */
} X_p3p3_T;
...
typedef struct {
  ...
  boolean_T int1_CSTATE;               /* '<S6>/int 1' */
  boolean_T int2_CSTATE;               /* '<S6>/int 2' */
} XDis_p3p3_T;
...
struct P_p3p3_T_ {
  ...
  real_T Joystick_gain_y;              /* Variable: Joystick_gain_y
                                        ...
                                        */
  real_T K3_3[10];                     /* Variable: K3_3
                                        * Referenced by: '<S4>/Ki matrix'
                                        */
  real_T P3_3[4];                      /* Variable: P3_3
                                        * Referenced by: '<S5>/Pi'
                                        */
  real_T Vs_star;                      /* Variable: Vs_star
  ...
  real_T Gain_Gain_lv;                 /* Expression: 180/pi
                                        ...
                                        */
  real_T offset_Value;                 /* Expression: 30
  ...
  real_T int1_IC;                      /* Expression: 0
                                        * Referenced by: '<S6>/int 1'
                                        */
  real_T int2_IC;                      /* Expression: 0
                                        * Referenced by: '<S6>/int 2'
                                        */
 ...
 * '<S4>'   : 'p3p3/Ki x'
 * '<S5>'   : 'p3p3/Pi r'
 * '<S6>'   : 'p3p3/integral effect'
 * '<S7>'   : 'p3p3/Heli 3D/Elevation rad to deg'
 * '<S8>'   : 'p3p3/Heli 3D/Elevation rate rad to deg'
 * '<S9>'   : 'p3p3/Heli 3D/Pitch rad to deg'
 * '<S10>'  : 'p3p3/Heli 3D/Pitch rate rad to deg'
 * '<S11>'  : 'p3p3/Heli 3D/Travel rad to deg'
 * '<S12>'  : 'p3p3/Heli 3D/Travel rate  rad to deg'
 */
