  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% p3p3_DW.e_dot_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 16;
	  section.data(3).dtTransOffset = 2;
	
	  ;% p3p3_DW.e_dot_c_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 17;
	  section.data(4).dtTransOffset = 3;
	
	  ;% p3p3_DW.p_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 18;
	  section.data(5).dtTransOffset = 4;
	
	  ;% p3p3_DW.p_c_PWORK.LoggedData
	  section.data(6).logicalSrcIdx = 19;
	  section.data(6).dtTransOffset = 5;
	
	  ;% p3p3_DW.p_dot_PWORK.LoggedData
	  ...
	  ;% p3p3_DW.TravelrateScopedegs1_PWORK.LoggedData
  ...
  targMap.checksum0 = 2097996831;
  targMap.checksum1 = 3131831005;
  targMap.checksum2 = 2264668433;
  targMap.checksum3 = 1023427908;
