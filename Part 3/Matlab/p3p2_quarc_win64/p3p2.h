...
struct P_p3p2_T_ {
  ...
  real_T Joystick_gain_y;              /* Variable: Joystick_gain_y
                                        ...
                                        */
  real_T K3_2[6];                      /* Variable: K3_2
                                        * Referenced by: '<S4>/K matrix'
                                        */
  real_T P3_2[4];                      /* Variable: P3_2
  ...
  boolean_T HILInitialize_set_analog_outp_c;/* Mask Parameter: HILInitialize_set_analog_outp_c
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_analog_out_dc;/* Mask Parameter: HILInitialize_set_analog_out_dc
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_digital_out_o;/* Mask Parameter: HILInitialize_set_digital_out_o
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_digital_ou_an;/* Mask Parameter: HILInitialize_set_digital_ou_an
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
 ...
 * '<S4>'   : 'p3p2/K x'
 * '<S5>'   : 'p3p2/P r'
 * '<S6>'   : 'p3p2/Heli 3D/Elevation rad to deg'
 * '<S7>'   : 'p3p2/Heli 3D/Elevation rate rad to deg'
 * '<S8>'   : 'p3p2/Heli 3D/Pitch rad to deg'
 * '<S9>'   : 'p3p2/Heli 3D/Pitch rate rad to deg'
 * '<S10>'  : 'p3p2/Heli 3D/Travel rad to deg'
 * '<S11>'  : 'p3p2/Heli 3D/Travel rate  rad to deg'
 */
