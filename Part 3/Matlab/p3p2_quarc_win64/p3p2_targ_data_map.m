  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% p3p2_P.HILInitialize_set_other_outpu_a
	  ...
	  ;% p3p2_P.HILInitialize_set_analog_inpu_j
	  ...
	  ;% p3p2_P.HILInitialize_set_analog_outp_i
	  ...
	  ;% p3p2_P.HILInitialize_set_analog_out_dc
	  section.data(10).logicalSrcIdx = 47;
	  section.data(10).dtTransOffset = 9;
	
	  ;% p3p2_P.HILInitialize_set_analog_outp_n
	  section.data(11).logicalSrcIdx = 48;
	  section.data(11).dtTransOffset = 10;
	
	  ;% p3p2_P.HILInitialize_set_analog_outp_f
	  ...
	  ;% p3p2_P.HILInitialize_set_clock_param_f
	  ...
	  ;% p3p2_P.HILInitialize_set_digital_out_f
	  ...
	  ;% p3p2_P.HILInitialize_set_digital_ou_an
	  ...
	  ;% p3p2_P.HILInitialize_set_encoder_par_p
	  section.data(27).logicalSrcIdx = 64;
	  section.data(27).dtTransOffset = 26;
	
	  ;% p3p2_P.HILInitialize_set_other_outpu_h
	  ...
	  ;% p3p2_P.HILInitialize_set_pwm_outputs_k
	  ...
	  ;% p3p2_P.HILInitialize_set_pwm_outputs_d
	  ...
	  ;% p3p2_P.HILInitialize_set_pwm_params__h
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% p3p2_DW.e_dot_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 15;
	  section.data(2).dtTransOffset = 1;
	
	  ;% p3p2_DW.p_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 16;
	  section.data(3).dtTransOffset = 2;
	
	  ;% p3p2_DW.p_c_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 17;
	  section.data(4).dtTransOffset = 3;
	
	  ;% p3p2_DW.p_dot_PWORK.LoggedData
	  ...
	  ;% p3p2_DW.TravelrateScopedegs1_PWORK.LoggedData
  ...
  targMap.checksum0 = 376753583;
  targMap.checksum1 = 660479240;
  targMap.checksum2 = 4186715619;
  targMap.checksum3 = 18927133;
