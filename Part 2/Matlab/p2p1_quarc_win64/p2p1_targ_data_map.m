  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% p2p1_P.waitt_dsec_Y0
	  section.data(26).logicalSrcIdx = 98;
	  section.data(26).dtTransOffset = 25;
	
	  ;% p2p1_P.waitt_dsec_YFinal
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% p2p1_DW.RateTransitiony_Buffer0
	  section.data(11).logicalSrcIdx = 10;
	  ...
	  ;% p2p1_DW.VdV_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 15;
	  section.data(2).dtTransOffset = 1;
	
	  ;% p2p1_DW.escope_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 16;
	  section.data(3).dtTransOffset = 2;
	
	  ;% p2p1_DW.pscope_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 17;
	  section.data(4).dtTransOffset = 3;
	
	  ;% p2p1_DW.tscope_PWORK.LoggedData
	  section.data(5).logicalSrcIdx = 18;
	  section.data(5).dtTransOffset = 4;
	
	  ;% p2p1_DW.Vss_PWORK.LoggedData
  ...
  targMap.checksum0 = 2400104852;
  targMap.checksum1 = 2695426961;
  targMap.checksum2 = 1703265816;
  targMap.checksum3 = 932016891;
