...
struct P_p2p2_T_ {
  ...
  real_T K_pd;                         /* Variable: K_pd
                                        * Referenced by: '<S5>/Kpd'
                                        */
  real_T K_pp;                         /* Variable: K_pp
                                        * Referenced by: '<S5>/Kpp'
                                        */
  real_T K_rp;                         /* Variable: K_rp
                                        * Referenced by: '<S6>/Krp'
                                        */
  real_T t_d;                          /* Variable: t_d
                                        * Referenced by: '<S5>/wait t_d sec'
                                        */
  ...
  real_T degtorad_Gain;                /* Expression: pi/180
                                        ...
                                        */
  real_T waitt_dsec_Y0;                /* Expression: 0
                                        * Referenced by: '<S5>/wait t_d sec'
                                        */
  real_T waitt_dsec_YFinal;            /* Expression: 1
                                        * Referenced by: '<S5>/wait t_d sec'
                                        */
  ...
  real_T Integrator_LowerSat;          /* Expression: -inf
                                        * Referenced by: '<S7>/Integrator'
                                        */
  real_T eref_Value;                   /* Expression: 0
                                        * Referenced by: '<Root>/e ref'
                                        */
 ...
 * '<S3>'   : 'p2p2/Heli 3D'
 * '<S4>'   : 'p2p2/Joystick'
 * '<S5>'   : 'p2p2/Pitch controller'
 * '<S6>'   : 'p2p2/Travel controller'
