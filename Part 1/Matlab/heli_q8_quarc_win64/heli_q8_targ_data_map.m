  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% heli_q8_P.HILInitialize_set_other_outpu_p
	  section.data(15).logicalSrcIdx = 14;
	  section.data(15).dtTransOffset = 14;
	
	  ;% heli_q8_P.HILInitialize_set_other_outpu_c
	  ...
	  ;% heli_q8_P.HILInitialize_set_analog_inpu_k
	  ...
	  ;% heli_q8_P.HILInitialize_set_analog_outp_o
	  ...
	  ;% heli_q8_P.HILInitialize_set_analog_out_c5
	  section.data(9).logicalSrcIdx = 43;
	  section.data(9).dtTransOffset = 8;
	
	  ;% heli_q8_P.HILInitialize_set_analog_outp_g
	  section.data(10).logicalSrcIdx = 44;
	  section.data(10).dtTransOffset = 9;
	
	  ;% heli_q8_P.HILInitialize_set_analog_out_oa
	  ...
	  ;% heli_q8_P.HILInitialize_set_clock_frequ_m
	  ...
	  ;% heli_q8_P.HILInitialize_set_clock_param_j
	  ...
	  ;% heli_q8_P.HILInitialize_set_digital_out_d
	  ...
	  ;% heli_q8_P.HILInitialize_set_encoder_cou_d
	  ...
	  ;% heli_q8_P.HILInitialize_set_encoder_par_j
	  ...
	  ;% heli_q8_P.HILInitialize_set_pwm_outputs_j
	  section.data(31).logicalSrcIdx = 65;
	  section.data(31).dtTransOffset = 30;
	
	  ;% heli_q8_P.HILInitialize_set_pwm_outputs_n
	  section.data(32).logicalSrcIdx = 66;
	  section.data(32).dtTransOffset = 31;
	
	  ;% heli_q8_P.HILInitialize_set_pwm_outputs_i
	  ...
	  ;% heli_q8_P.HILInitialize_set_pwm_params__b
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% heli_q8_DW.escope_PWORK.LoggedData
	  section.data(2).logicalSrcIdx = 15;
	  section.data(2).dtTransOffset = 1;
	
	  ;% heli_q8_DW.pscope_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 16;
	  section.data(3).dtTransOffset = 2;
	
	  ;% heli_q8_DW.tscope_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 17;
	  section.data(4).dtTransOffset = 3;
	
	  ;% heli_q8_DW.Vss_PWORK.LoggedData
  ...
  targMap.checksum0 = 3103428003;
  targMap.checksum1 = 2319036705;
  targMap.checksum2 = 2654236164;
  targMap.checksum3 = 2143126681;
