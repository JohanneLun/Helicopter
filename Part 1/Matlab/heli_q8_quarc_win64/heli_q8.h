...
typedef struct {
  ...
  struct {
    void *LoggedData;
  } escope_PWORK;                      /* '<Root>/e scope' */

  struct {
    void *LoggedData;
  } pscope_PWORK;                      /* '<Root>/p scope' */

  struct {
    void *LoggedData;
  } tscope_PWORK;                      /* '<Root>/t scope' */
...
struct P_heli_q8_T_ {
  ...
  boolean_T HILInitialize_set_analog_outp_c;/* Mask Parameter: HILInitialize_set_analog_outp_c
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_analog_out_c5;/* Mask Parameter: HILInitialize_set_analog_out_c5
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_analog_outp_g;/* Mask Parameter: HILInitialize_set_analog_outp_g
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_analog_out_oa;/* Mask Parameter: HILInitialize_set_analog_out_oa
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_clock_frequen;/* Mask Parameter: HILInitialize_set_clock_frequen
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_clock_frequ_m;/* Mask Parameter: HILInitialize_set_clock_frequ_m
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  boolean_T HILInitialize_set_encoder_par_j;/* Mask Parameter: HILInitialize_set_encoder_par_j
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  boolean_T HILInitialize_set_other_outpu_b;/* Mask Parameter: HILInitialize_set_other_outpu_b
                                             * Referenced by: '<Root>/HIL Initialize'
                                             */
  ...
  real_T Gain_Gain;                    /* Expression: 180/pi
                                        ...
                                        */
  real_T offsetelevation_Value;        /* Expression: 30
                                        * Referenced by: '<S3>/offset elevation'
                                        */
  ...
  real_T Gainx_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T Gain_Gain_f;                  /* Expression: 10
