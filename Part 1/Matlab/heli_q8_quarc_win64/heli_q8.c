 ...
 * C source code generated on : Fri Sep 08 15:30:28 2017
 *
...
void heli_q8_output0(void)             /* Sample time: [0.0s, 0.0s] */
{
  ...
  if (rtmIsMajorTimeStep(heli_q8_M)) {
     ...
     *  Gain: '<S7>/Gain'
     */
    heli_q8_B.Sum = heli_q8_P.Gain_Gain * heli_q8_B.ElevationCounttorad -
      heli_q8_P.offsetelevation_Value;
    ...
    /* Gain: '<S9>/Gain' */
    heli_q8_B.Gain = heli_q8_P.Gain_Gain_e * heli_q8_B.PitchCounttorad;
    ...
    /* Gain: '<S11>/Gain' */
    heli_q8_B.Gain_l = heli_q8_P.Gain_Gain_g * heli_q8_B.TravelCounttorad;
    ...
    /* Gain: '<Root>/Gain' */
    rtb_BackmotorSaturation = heli_q8_P.Gain_Gain_f * heli_q8_B.Joystick_gain_x;

    /* Sum: '<S1>/Add' */
    rtb_Add = rtb_BackmotorSaturation + heli_q8_B.Gain1;

    /* Gain: '<S1>/Back gain' incorporates:
     *  Sum: '<S1>/Subtract'
     */
    rtb_BackmotorSaturation = (heli_q8_B.Gain1 - rtb_BackmotorSaturation) *
      heli_q8_P.Backgain_Gain;

    /* Gain: '<S1>/Front gain' */
    rtb_FrontmotorSaturation = heli_q8_P.Frontgain_Gain * rtb_Add;
  }

  /* Gain: '<S8>/Gain' incorporates:
   *  TransferFcn: '<S3>/Elevation: Transfer Fcn'
   */
  heli_q8_B.Gain_p = (heli_q8_P.ElevationTransferFcn_C *
                      heli_q8_X.ElevationTransferFcn_CSTATE +
                      heli_q8_P.ElevationTransferFcn_D *
                      heli_q8_B.ElevationCounttorad) * heli_q8_P.Gain_Gain_c;
  if (rtmIsMajorTimeStep(heli_q8_M)) {
  }
...
void heli_q8_initialize(void)
{
  ...
  /* S-Function Block: heli_q8/HIL Initialize (hil_initialize_block) */
  {
    ...
    if ((heli_q8_P.HILInitialize_set_analog_input_ && !is_switching) ||
        (heli_q8_P.HILInitialize_set_analog_inpu_k && is_switching)) {
      {
        int_T i1;
    ...
    if ((heli_q8_P.HILInitialize_set_analog_output && !is_switching) ||
        (heli_q8_P.HILInitialize_set_analog_outp_o && is_switching)) {
      {
        int_T i1;
    ...
    if ((heli_q8_P.HILInitialize_set_analog_outp_c && !is_switching) ||
        (heli_q8_P.HILInitialize_set_analog_out_c5 && is_switching)) {
      {
        int_T i1;
    ...
    if ((heli_q8_P.HILInitialize_set_encoder_param && !is_switching) ||
        (heli_q8_P.HILInitialize_set_encoder_par_j && is_switching)) {
      {
        int_T i1;
    ...
    if ((heli_q8_P.HILInitialize_set_encoder_count && !is_switching) ||
        (heli_q8_P.HILInitialize_set_encoder_cou_d && is_switching)) {
      {
        int_T i1;
    ...
    if ((heli_q8_P.HILInitialize_set_pwm_params_at && !is_switching) ||
        (heli_q8_P.HILInitialize_set_pwm_params__b && is_switching)) {
    ...
    if ((heli_q8_P.HILInitialize_set_pwm_outputs_a && !is_switching) ||
        (heli_q8_P.HILInitialize_set_pwm_outputs_o && is_switching)) {
      {
        int_T i1;
        real_T *dw_POValues = &heli_q8_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
    ...
    if (heli_q8_P.HILInitialize_set_pwm_outputs_i) {
      {
        int_T i1;
        real_T *dw_POValues = &heli_q8_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
...
void heli_q8_terminate(void)
{
  ...
  /* S-Function Block: heli_q8/HIL Initialize (hil_initialize_block) */
  {
    ...
    is_switching = false;
    if ((heli_q8_P.HILInitialize_set_analog_out_oa && !is_switching) ||
        (heli_q8_P.HILInitialize_set_analog_outp_g && is_switching)) {
      {
        int_T i1;
        real_T *dw_AOVoltages = &heli_q8_DW.HILInitialize_AOVoltages[0];
        for (i1=0; i1 < 8; i1++) {
    ...
    if ((heli_q8_P.HILInitialize_set_pwm_outputs_n && !is_switching) ||
        (heli_q8_P.HILInitialize_set_pwm_outputs_j && is_switching)) {
      {
        int_T i1;
        real_T *dw_POValues = &heli_q8_DW.HILInitialize_POValues[0];
        for (i1=0; i1 < 8; i1++) {
...
RT_MODEL_heli_q8_T *heli_q8(void)
{
  ...
  /* External mode info */
  heli_q8_M->Sizes.checksums[0] = (3103428003U);
  heli_q8_M->Sizes.checksums[1] = (2319036705U);
  heli_q8_M->Sizes.checksums[2] = (2654236164U);
  heli_q8_M->Sizes.checksums[3] = (2143126681U);
  ...
  heli_q8_M->Sizes.numBlocks = (50);   /* Number of blocks */
